...
data=read.csv("data_September/net_2019-09-05_to_2019-09-25.csv")
str(data)
stations=unique(data$device_id)
stations_latlon=read.csv("data_September/stations.csv")
str(stations_latlon)
...
ggsave(filename = "overview_netatmo_05.09.pdf", width=14, height=7)

#individually name lists to puzzle them together
list_netatmo_3=list_netatmo