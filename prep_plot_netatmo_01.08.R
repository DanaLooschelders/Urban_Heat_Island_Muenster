...
data=read.csv("data_August/net_2019-08-01_to_2019-08-20.csv")
str(data)
stations=unique(data$device_id)
stations_latlon=read.csv("data_August/stations.csv")
str(stations_latlon)
...
ggsave(filename = "overview_netatmo_01.08.pdf", width=14, height=7)

#individually name lists to puzzle them together
list_netatmo_1=list_netatmo