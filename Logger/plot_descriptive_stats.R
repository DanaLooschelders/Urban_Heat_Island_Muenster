...
ggsave(filename=paste("overview_mean_plot",  
                      list_iButton_24h_mms[[1]][1,1],".jpg")) #name plot with date
...
ggsave(filename=paste("overview_median_plot",  
                      list_iButton_24h_mms[[1]][1,1],".jpg")) #name plot with date
...
ggsave(filename=paste("overview_sd_plot",  
                      list_iButton_24h_mms[[1]][1,1],".jpg")) #name plot with date
...
ggsave(filename=paste("grid_stats_plot",  
                      list_iButton_24h_mms[[i]][1,1], "logger",
                      names(list_iButton_24h_mms)[i],".jpg"), plot =grid_plot ) #name plot with logger name, date
}
