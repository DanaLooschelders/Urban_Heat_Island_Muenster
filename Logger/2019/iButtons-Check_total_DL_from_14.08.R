...
setwd("C:/00_Dana/Uni/6. Semester/Bachelorarbeit/logger_data/UHI_Muenster_Data/dat_14.08/")
#################
# Data iButtons #
#################
...
iButton_ID=read.table("0D000000519CE121_190829.csv", sep = ",", dec = ".", header = F, skip = 4,
...
start_time=strptime("2019-08-15 00:00:00", "%Y-%m-%d %H:%M:%S")
end_time=strptime("2019-08-27 23:59:00", "%Y-%m-%d %H:%M:%S") #set odd time because otherwise the lengths differ between loggers
