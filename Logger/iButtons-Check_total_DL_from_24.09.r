...
setwd("C:/00_Dana/Uni/6. Semester/Bachelorarbeit/logger_data/UHI_20190924-20191109/")
#################
# Data iButtons #
#################
...
iButton_ID=read.table("100_1400000051A3B521_200604.csv", sep = ",", dec = ".", header = F, skip = 4,
